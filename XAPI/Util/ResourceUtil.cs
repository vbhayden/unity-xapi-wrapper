...
namespace XAPI
{
	...
	public class StateResourceQueryArgs : IQueryArguments
	{
		...
		public StateResourceQueryArgs(string activityKey = "", XActor agent = null)
		{
	...
	/// </summary>
	[System.Serializable]
	public class AgentResource : XObject
	{
		/// <summary>
	...
	public class AgentResourceQueryArgs : IQueryArguments
	{
		...
		/// </summary>
		public AgentResourceQueryArgs(XActor agent)
		{
			this.Agent = agent;
		}
	...
	public class AgentProfileQueryArgs : IQueryArguments
	{
		...
		/// </summary>
		/// <param name="agent">Agent.</param>
		public AgentProfileQueryArgs(XActor agent, string profileKey)
		{
			this.Agent = agent;
	...
	//
	// Activity Objects are already defined as XActivity.  These objects will be returned from
