...
namespace XAPI
{
    ...
    public sealed class XAPIWrapper
    {
        ...
        private static XActor commonActor;
        ...
        public static void AssignCommonActor(XActor actor)
        {
        ...
        public static void SendStatement(Statement statement, Action<Statement, string, UnityWebRequest> callback = null)
        {
        ...
        /// <param name="xVerb"></param>
        /// <param name="xObject"></param>
        /// <param name="xResult"></param>
        public static void SendStatement(XActor xActor, XVerb xVerb, XActivity xActivity, XResult xResult = null, Action<Statement, string, UnityWebRequest> callback = null)
        {
            var statement = new Statement(xActor, xVerb, xActivity);

            if (xResult != null)
                statement.MainResult = xResult;
        ...
        /// <param name="xObject"></param>
        /// <param name="xResult"></param>
        public static void SendStatement(XVerb xVerb, XActivity xActivity, XResult xResult = null, Action<Statement, string, UnityWebRequest> callback = null)
        {
            ...
            XAPIWrapper.SendStatement(XAPIWrapper.CommonActor, xVerb, xActivity, xResult, callback);
        }   
        ...
        /// </summary>
        /// <value></value>
        public static XActor CommonActor
        {
