...
namespace XAPI
{
	...
	public class XContext
	{
		...
		public XContextActivities ContextActivities
		{
		...
		public XStatementRef Statement
		{
		...
		private XActor instructor;
		private XActor team;
		private XContextActivities contextActivities;
		private string revision;
		private string platform;
		private string language;
		private XStatementRef statement;
		private Dictionary<string, string> extensions;

		/// <summary>
		/// Initializes a new instance of the <see cref="XAPI.XContext"/> class.
		/// 
	...
	[System.Serializable]
	public class XContextActivities
	{
		/// <summary>
		...
		public List<XActivity> Groupings
		{
		...
		public List<XActivity> Categories
		{
		...
		// Private fields
		private List<XActivity> parent;
		private List<XActivity> grouping;
		private List<XActivity> category;
		private List<XActivity> other;

		/// <summary>
		/// Initializes a new instance of the <see cref="XAPI.XContextActivities"/> class.
		/// 
		/// Each List can be manipulated manually, or you can use the helper functions for basic
		/// functionality with the lists.
		/// </summary>
		[JsonConstructor]    
		public XContextActivities()
		{
		...
		/// <summary>
		/// Adds a parent activity (XActivity instance).
		/// </summary>
		/// <param name="parentActivity">Parent activity.</param>
		public void AddParent(XActivity activity)
		{
		...
		/// <summary>
		/// Adds a Grouping activity (XActivity instance).
		/// </summary>
		/// <param name="GroupingActivity">Grouping activity.</param>
		public void AddGrouping(XActivity activity)
		{
		...
		/// <summary>
		/// Adds a category for this activity (XActivity instance).
		/// </summary>
		/// <param name="parentActivity">Parent activity.</param>
		public void AddCategory(XActivity activity)
		{
			this.AddToList(activity, ref this.parent);
		}
		...
		/// <summary>
		/// Adds a miscellaneous activity (XActivity instance).
		/// </summary>
		/// <param name="parentActivity">Parent activity.</param>
		public void AddOther(XActivity activity)
		{
		...
		private void AddToList(XActivity activity, ref List<XActivity> activityList)
		{
			if (activityList == null)
				activityList = new List<XActivity>();
		...
		/// <param name="activity">Activity.</param>
		/// <param name="activityList">Activity list.</param>
		private void AddToList(string activityKey, ref List<XActivity> activityList)
		{
			if (activityList == null)
				activityList = new List<XActivity>();

			this.AddToList(new XActivity(activityKey), ref activityList);
		}
		...
		/// </summary>
		/// <param name="activityList">Activity list.</param>
		private void ClearList(ref List<XActivity> activityList)
		{
			if (activityList != null)
				activityList.Clear();
