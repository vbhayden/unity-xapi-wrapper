...
namespace XAPI
{
	...
	{  
        ...
        /// <summary>
        /// Search for a specific verb using the XVerb object.
        /// 
        /// This is a property that assigns the given verb ID as the query target.
        /// </summary>
        public XVerb PredefinedVerb
        {
            set 
            {
        ...
        private string EncodeInt(string name, int? val, string closure = "&")
        {
            if (val == null)
                ...
                return name + "=" + WWW.EscapeURL(val.Value.ToString()) + closure;
        }
        ...
        private string EncodeString(string name, string val, string closure = "&")
        {
            if (val == null)
                ...
                return name + "=" + WWW.EscapeURL(val) + closure;
        }
        ...
        {   
            if (val == null)
                ...
                return name + "=" + WWW.EscapeURL(val.Value.ToLongDateString()) + closure;
        }
        #endregion
    }
}