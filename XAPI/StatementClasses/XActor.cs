...
namespace XAPI
{
	...
	public class XActor : XObject
	{
		...
		public List<XActor> GroupMembers
		{
			get
			{
		...
		private List<XActor> groupMembers;
		private string name;

		/// <summary>
		/// Initializes a new instance of the <see cref="XAPI.XActor"/> class.
		/// 
		...
		public XActor()
		{
			this.groupMembers = new List<XActor>();
		}
		...
		private XActor(IFIType ifi, bool isGroup = false, string name = "")
		{
		...
		public void AddGroupMember(XActor groupMember)
		{
		...
		public static XActor FromMailbox(string mailbox, bool isGroup = false, string name = "")
		{
			// Mailbox-style IFI
			XActor actor = new XActor(IFIType.Mailbox, isGroup, name);
		...
		/// <returns>The mailbox.</returns>
		/// <param name="mailbox">Mailbox.</param>
		public static XActor FromMailboxSHA1(string mailbox, bool isGroup = false, string name = "")
		{
			// Mailbox-style IFI
			XActor actor = new XActor(IFIType.MailboxSHA1, isGroup, name);
		...
		/// <returns>The mailbox.</returns>
		/// <param name="mailbox">Mailbox.</param>
		public static XActor FromOpenID(string id, bool isGroup = false, string name = "")
		{
			// Mailbox-style IFI
			XActor actor = new XActor(IFIType.OpenID, isGroup, name);
		...
		/// <returns>The mailbox.</returns>
		/// <param name="mailbox">Mailbox.</param>
		public static XActor FromAccount(ActorAccount actorAccount, bool isGroup = false, string name = "")
		{
			// Mailbox-style IFI
			XActor actor = new XActor(IFIType.Account, isGroup, name);
		...
		public static XActor FromAccount(string homePage, string accountName, bool isGroup = false, string name = "")
		{
			// Mailbox-style IFI
			XActor actor = new XActor(IFIType.Account, isGroup, name);
